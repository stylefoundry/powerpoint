...
module Powerpoint
    ...
    class FFTrendTextRightImageLeft
      ...
      def save_rel_xml(extract_path, index)
        render_view('ff_text_right_image_left_rel.xml.erb', "#{extract_path}/ppt/slides/_rels/slide#{index}.xml.rels")
      end
      private :save_rel_xml

      def save_slide_xml(extract_path, index)
        render_view('ff_text_right_image_left_slide.xml.erb', "#{extract_path}/ppt/slides/slide#{index}.xml")
      end
